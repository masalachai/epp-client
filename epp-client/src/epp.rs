...
pub use request::domain::namestore::check::*;
pub use request::domain::namestore::create::*;
pub use request::domain::namestore::info::*;
...
pub use response::domain::namestore::check::*;
pub use response::domain::namestore::create::*;
pub use response::domain::namestore::info::*;
