...
pub use request::domain::namestore::delete::*;
pub use request::domain::namestore::info::*;
pub use request::domain::namestore::renew::*;
pub use request::domain::namestore::transfer::*;
pub use request::domain::namestore::update::*;
...
pub use response::domain::namestore::delete::*;
pub use response::domain::namestore::info::*;
pub use response::domain::namestore::renew::*;
pub use response::domain::namestore::transfer::*;
pub use response::domain::namestore::update::*;
